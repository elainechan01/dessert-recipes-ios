...
struct DessertDetail: Codable, Hashable, CaseIterable {
    ...
    private var measurementList: [String] {
    ...
    var ingredientMeasurementList: [[String]] {
        var allLists: [[String]] = []
        for i in 1..<ingredientList.count {
            allLists.append([ingredientList[i], measurementList[i]])
        }
        return allLists
    }
...
struct DessertDetailList: Codable, Hashable {
